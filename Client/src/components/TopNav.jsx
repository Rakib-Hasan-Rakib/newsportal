      ...
      <div className=" bg-green-400 text-white">
        <div className="flex justify-between items-center w-10/12 mx-auto py-2">
          ...
          <div className="flex justify-between items-center gap-3">
            <Link target="_blank" title="visit facebook">
              <FaFacebook size={24} />
            </Link>
            <Link
            ...
            <Link target="_blank" title="visit pinterest">
              <FaPinterestP size={24} />
            </Link>
            <Link target="_blank" title="visit youtube">
              <FaYoutube size={24} />
            </Link>

            <div className="ml-16">
              <label className="swap swap-rotate" title="change theme?">
